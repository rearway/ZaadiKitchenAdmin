...
const MOCK_CUSTOMERS: Customer[] = [
  {
    ...
    daysLeft: 14,
    wallet: 'SAR 28.00',
    address: 'Olaya Towers, Floor 14, Desk 2',
    issues: '0 open / 1 resolved',
  },
  {
    id: '2',
    name: 'Sara Aljohani',
    ...
    daysLeft: 62,
    wallet: 'SAR 0.00',
    address: 'KAFD Area 4, Desk 2B',
    issues: '1 open / 0 resolved',
  },
  {
    id: '3',
    ...
    daysLeft: 3,
    wallet: 'SAR 15.00',
    address: 'Digital City, Bldg 3, F2',
    issues: '0 open / 0 resolved',
  },
  {
    id: '4',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
          {['All (248)', 'Active', 'New Today', 'Churned', 'Month', 'Quarterly'].map(
            (filter, i) => (
              <button
                key={filter}
                style={{
        ...
        {MOCK_CUSTOMERS.map((c) => {
          ...
          return (
            ...
            >
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: '12px',
                        borderRadius: '50%',
                        backgroundColor: getPlanColor(c.plan),
                      }}
                    />
              ...
              {isExpanded && (
                <div
                  style={{ padding: '24px', borderTop: '1px solid #333', backgroundColor: '#111' }}
                >
                  <div
                    style={{
                      display: 'grid',
                  ...
                  >
                    ...
                    <InfoCard
                      label="Address"
                      value={c.address.split(',')[0]}
                      sub={c.address.split(',')[1] || ''}
                    />
                    <InfoCard
                      label="Issues"
                      value={c.issues.split(' / ')[0]}
                      sub={c.issues.split(' / ')[1]}
                    />
                  </div>
                  ...
                  <div style={{ display: 'flex', gap: '12px' }}>
                    ...
                    <button className="btn-ghost" style={{ border: '1px solid #333' }}>
                      📋 View history
                    </button>
